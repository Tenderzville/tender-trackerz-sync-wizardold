  ...
  public: {
    Tables: {
      ai_analyses: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_analyses_tender_fk"
            columns: ["tender_id"]
            isOneToOne: false
      ...
      rfq_quotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfq_quotes_rfq_fk"
            columns: ["rfq_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "rfq_quotes_supplier_fk"
            columns: ["supplier_id"]
            isOneToOne: false
      ...
      tender_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "tender_analytics_tender_fk"
            columns: ["tender_id"]
            isOneToOne: false
            referencedRelation: "tenders"
            referencedColumns: ["id"]
