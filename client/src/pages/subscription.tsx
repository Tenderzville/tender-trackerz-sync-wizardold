    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Get <span className="font-medium text-foreground">FREE daily tender alerts</span> delivered straight to your phone — new tenders posted every morning & evening automatically!
              </p>
            </div>
          ...
          <Card key={plan.id} className={`relative ${plan.popular ? 'border-primary shadow-lg' : ''}`}>
            ...
            <CardContent>
              ...
              >
                ...
                ) : isCurrentPlan(plan.id) ? 'Current Plan' : plan.price === 0 ? 'Get Started' : 'Subscribe'}
              </Button>
            </CardContent>
          </Card>
        ))}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pay annually and get 2 months free</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 border rounded-lg">
              ...
              <Button className="w-full mt-4" variant="outline"
                ...
                {paymentLoading && selectedPlan === 'pro_annual' ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" />Processing...</> : 'Subscribe Annually'}
              </Button>
            </div>
            <div className="p-4 border rounded-lg">
              <div className="flex justify-between items-center mb-2">
              ...
              <Button className="w-full mt-4" variant="outline"
                ...
                {paymentLoading && selectedPlan === 'business_annual' ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" />Processing...</> : 'Subscribe Annually'}
              </Button>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Gift className="w-5 h-5" />Refer & Earn</CardTitle>
          <CardDescription>Invite friends and earn loyalty points</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
            <div className="flex-1">
